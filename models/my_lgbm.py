...
EXEC_TIME = 'my-lgbm-' + datetime.now().strftime("%Y%m%d-%H%M%S")
...
def load_data():
    ...
    X_train = pd.read_table(root + 'X_train.txt', sep=' ', header=None)
    ...
    X_test = pd.read_table(root + 'X_test.txt', sep=' ', header=None)
